...
contains
  ...
  associate(c => self%coef)
    ...
    case(9) ! 17th order
      ...
      c(0,3,3) =                                     0._RPP;c(1,3,3) =                                     0._RPP
      !                    /                               ;                     /
      c(3,3,3) =                                     0._RPP;c(3,3,3) =   1553225813426501._RPP/ 186810624000._RPP
      !                    /                               ;                     /
