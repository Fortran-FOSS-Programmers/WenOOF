...
contains
  ...
  select case(i)
    ...
    case(4) ! 7th order
      ! stencil 0
      !              i*i              ;            (i-1)*i              ;            (i-2)*i
      c(0,0,0) =  2107._R_P / 240._R_P; c(1,0,0) = -1567._R_P /  40._R_P; c(2,0,0) =  3521._R_P / 120._R_P
      !          (i-3)*i
      c(3,0,0) =  -309._R_P /  40._R_P
      !               /               ;            (i-1)*(i-1)          ;            (i-2)*(i-1)
      c(0,1,0) =     0._R_P           ; c(1,1,0) = 11003._R_P / 240._R_P; c(2,1,0) = -8623._R_P / 120._R_P
      !          (i-3)*(i-1)
      c(3,1,0) =  2321._R_P / 120._R_P
      !               /               ;                 /               ;            (i-2)*(i-2)
      c(0,2,0) =     0._R_P           ; c(1,2,0) =     0._R_P           ; c(2,2,0) =  7043._R_P / 240._R_P
      !          (i-3)*(i-2)
      c(3,2,0) =  -647._R_P /  40._R_P
      !               /               ;                 /               ;                 /
      c(0,3,0) =     0._R_P           ; c(1,3,0) =     0._R_P           ; c(2,3,0) =     0._R_P
      !          (i-3)*(i-3)
      c(3,3,0) =   547._R_P / 240._R_P
      ! stencil 1
      !          (i+1)*(i+1)          ;                i*(i+1)          ;            (i-1)*(i+1)
      c(0,0,1) =   547._R_P / 240._R_P; c(1,0,1) = -1261._R_P / 120._R_P; c(2,0,1) =   961._R_P / 120._R_P
      !          (i-2)*(i+1)
      c(3,0,1) =  -247._R_P / 120._R_P
      !               /               ;                i*i              ;            (i-1)*i
      c(0,1,1) =     0._R_P           ; c(1,1,1) =  3443._R_P / 240._R_P; c(2,1,1) = -2983._R_P / 120._R_P
      !          (i-2)*i
      c(3,1,1) =   267._R_P /  40._R_P
      !               /               ;                 /               ;            (i-1)*(i-1)
      c(0,2,1) =     0._R_P           ; c(1,2,1) =     0._R_P           ; c(2,2,1) =  2843._R_P / 240._R_P
      !          (i-2)*(i-1)
      c(3,2,1) =  -821._R_P / 120._R_P
      !               /               ;                 /               ;                 /
      c(0,3,1) =     0._R_P           ; c(1,3,1) =     0._R_P           ; c(2,3,1) =     0._R_P
      !          (i-2)*(i-2)
      c(3,3,1) =    89._R_P /  80._R_P
      ! stencil 2
      !          (i+2)*(i+2)          ;            (i+1)*(i+2)          ;                i*(i+2)
      c(0,0,2) =    89._R_P /  80._R_P; c(1,0,2) =  -821._R_P / 120._R_P; c(2,0,2) =   267._R_P /  40._R_P
      !          (i-1)*(i+2)
      c(3,0,2) =  -247._R_P / 120._R_P
      !               /               ;            (i+1)*(i+1)          ;                i*(i+1)
      c(0,1,2) =     0._R_P           ; c(1,1,2) =  2843._R_P / 240._R_P; c(2,1,2) = -2983._R_P / 120._R_P
      !          (i-1)*(i+1)
      c(3,1,2) =   961._R_P / 120._R_P
      !               /               ;                 /               ;                i*i
      c(0,2,2) =     0._R_P           ; c(1,2,2) =     0._R_P           ; c(2,2,2) =  3443._R_P / 240._R_P
      !          (i-1)*i
      c(3,2,2) = -1261._R_P / 120._R_P
      !               /               ;                 /               ;                 /
      c(0,3,2) =     0._R_P           ; c(1,3,2) =     0._R_P           ; c(2,3,2) =     0._R_P
      !          (i-1)*(i-1)
      c(3,3,2) =   547._R_P / 240._R_P
      ! stencil 3
      !          (i+3)*(i+3)          ;            (i+2)*(i+3)          ;            (i+1)*(i+3)
      c(0,0,3) =   547._R_P / 240._R_P; c(1,0,3) =  -647._R_P /  40._R_P; c(2,0,3) =  2321._R_P / 120._R_P
      !              i*(i+3)
      c(3,0,3) =  -309._R_P /  40._R_P
      !               /               ;            (i+2)*(i+2)          ;      (i+1)*(i+2)
      c(0,1,3) =     0._R_P           ; c(1,1,3) =  7043._R_P / 240._R_P; c(2,1,3) = -8623._R_P / 120._R_P
      !              i*(i+2)
      c(3,1,3) =  3521._R_P / 120._R_P
      !               /               ;                 /               ;      (i+1)*(i+1)
      c(0,2,3) =     0._R_P           ; c(1,2,3) =     0._R_P           ; c(2,2,3) = 11003._R_P / 240._R_P
      !              i*(i+1)
      c(3,2,3) = -1567._R_P /  40._R_P
      !               /               ;                 /               ;           /
      c(0,3,3) =     0._R_P           ; c(1,3,3) =     0._R_P           ; c(2,3,3) =     0._R_P
      !              i*i
      c(3,3,3) =  2107._R_P / 240._R_P
    case(5) ! 9th order
      ! stencil 0
      !              i*i                 ;             (i-1)*i                ;             (i-2)*i
    ...
    case(7) ! 13th order
      ...
      !                  (i-5)*(i+1)
      c(6,0,1) =    945155329._R_P/59875200._R_P

      !                    /                    ;                       i*(i-1)
      c(0,1,1) =                          0._R_P; c(1,1,1) =      127942497._R_P/246400._R_P
      !                  (i-1)*(i-1)            ;                   (i-2)*(i-1)
    ...
    case(8) ! 15th order
      ...
      !                    /                              ;                      /
      c(6,7,0) =                                    0._R_P; c(7,7,0) =      986005096387._R_P/  20756736000._R_P
    ...
    case(9) ! 17th order
      ...
      c(0,3,3) =                                     0._R_P;c(1,3,3) =                                     0._R_P
      !                    /                               ;                     /
      c(2,3,3) =                                     0._R_P;c(3,3,3) =   1553225813426501._R_P/ 186810624000._R_P
      !                    /                               ;                     /
      ...
      !                    /                               ;                     /
      c(0,1,4) =                                     0._R_P;c(1,1,4) =    119979314906981._R_P/1307674368000._R_P
      !                    /                               ;                     /
      ...
      c(4,7,4) =                                     0._R_P;c(5,7,4) =                                     0._R_P
      !                    /                               ;                     /
      c(6,7,4) =                                     0._R_P;c(7,7,4) =    119979314906981._R_P/1307674368000._R_P
      !                    /                               ;                     /
      ...
      c(0,3,7) =                                     0._R_P;c(1,3,7) =                                     0._R_P
      !                    /                               ;                     /
      c(2,3,7) =                                     0._R_P;c(3,3,7) =  18518028023237957._R_P/ 186810624000._R_P
      !                    /                               ;                     /
