...
abstract interface
  ...
  pure subroutine compute_int_interface(self, ord, beta, kappa, values)
  !< Compute alpha (interpolate).
  import :: alpha_object, I_P, R_P
  ...
  pure subroutine compute_rec_interface(self, ord, beta, kappa, values)
