...
abstract interface
  ...
  pure subroutine interpolate_int_debug_interface(self, ord, stencil, interpolation, si, weights)
  !< Interpolate (interpolate) values (providing also debug values).
  import :: interpolator_object, I_P, R_P
  ...
  pure subroutine interpolate_int_standard_interface(self, ord, stencil, interpolation)
  ...
  pure subroutine interpolate_rec_debug_interface(self, ord, stencil, interpolation, si, weights)
  ...
  pure subroutine interpolate_rec_standard_interface(self, ord, stencil, interpolation)
